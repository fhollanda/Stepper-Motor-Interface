...
nohup python /Stepper-Motor-Interface/motor/rest_api.py > /var/log/smi/motor.log 2>&1 &
deactivate

. /Stepper-Motor-Interface/tektronix/env/bin/activate
nohup python /Stepper-Motor-Interface/tektronix/rest_api.py > /var/log/smi/tektronix.log 2>&1 &
deactivate
